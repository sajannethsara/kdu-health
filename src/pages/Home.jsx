    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-blue-100 to-purple-200">
      ...
      <header className="flex items-center justify-between px-6 py-4 bg-white shadow-md">
        <div className="flex items-center gap-3">
          {/* Logo (using vite.svg as placeholder) */}
          <img src="/vite.svg" alt="QuickCare Logo" className="h-10 w-10" />
          <span className="text-2xl font-bold text-blue-700 tracking-wide">QUICK CARE</span>
        </div>
        <div className="flex items-center gap-4">
          <button className="text-blue-700 font-semibold hover:underline" onClick={() => navigate('/login')}>Sign In</button>
          {/* Hamburger menu */}
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 py-8">
        ...
        {/* Illustration */}
        <div className="mb-6">
          {/* Use the WhatsApp image as illustration if available, else fallback to react.svg */}
          <img
